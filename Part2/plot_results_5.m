...
grid on
legend({'surge', 'surge_sp', 'surge_obs'}, 'FontSize', commonFontSize)
...
grid on
legend({'sway', 'sway_sp', 'sway_obs'}, 'FontSize', commonFontSize)
...
grid on
legend({'yaw', 'yaw_sp', 'yaw_obs'}, 'FontSize', commonFontSize)
