...
simulation = 5; %change from simulation 1 - 7 to see plots
simulation_time = 1000; %sim1 = 300; sim2 - sim5 = 6500; sim6 = 3000; sim7 = 1000;
observer_type = 0; % 1 - NonLinear Passive, 0 - EKF
thruster_type = 0; % 1 - Pseudo Inverse, 0 - Quadratic Programming
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 1);
set_param(simulation_selector_str, 'Commented', 'on')

simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 2);
set_param(simulation_selector_str, 'Commented', 'on')

simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 3);
set_param(simulation_selector_str, 'Commented', 'on')

simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 4);
set_param(simulation_selector_str, 'Commented', 'on')

simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 5);
set_param(simulation_selector_str, 'Commented', 'on')

simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 6);
set_param(simulation_selector_str, 'Commented', 'on')

simulation_selector_str = sprintf('part2_MAIN/Simulation %d', 7);
set_param(simulation_selector_str, 'Commented', 'on')
...
%set simulations
%setting simulation
simulation_selector_str = sprintf('part2_MAIN/Simulation %d', simulation);
...
sim('part2_MAIN', simulation_time)
